      ...
      body: ListView(
        ...
        children: [
          Container(
            width: 52,
            height: 52,
            decoration: BoxDecoration(color: T.brand50, borderRadius: BorderRadius.circular(14)),
            child: const Icon(Icons.sms_outlined, size: 26, color: T.brand),
          ),
          const SizedBox(height: 20),
          const Text(
            'Before we ask for SMS access',
            style: TextStyle(fontSize: 21, fontWeight: FontWeight.w800, color: T.ink, height: 1.2),
          ),
          const SizedBox(height: 8),
          const Text(
            "Android's next screen won't explain this, so here's exactly what happens.",
            style: TextStyle(fontSize: 13.8, color: T.ink70, height: 1.5),
          ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: T.ink)),
                const SizedBox(height: 3),
                Text(body, style: const TextStyle(fontSize: 13, height: 1.5, color: T.ink70)),
              ],
            ),
          ),
        ],
